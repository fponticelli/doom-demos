...
ClickCounter.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		...
		if(this.props.clicks == 0) {
			childrenNodes = doom_core__$VNodes_VNodes_$Impl_$.children([doom_core__$VNode_VNode_$Impl_$.el("p",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("Please click somewhere in this page",null,null)]))]);
		} else {
			var childrenNodes1 = doom_core__$VNode_VNode_$Impl_$.el("h1",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("Clicks " + Std.string(this.props.clicks),null,null)]));
			...
			var childrenNodes2 = doom_core__$VNode_VNode_$Impl_$.el("div",_g,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("",null,null)]));
			...
			childrenNodes = doom_core__$VNodes_VNodes_$Impl_$.children([childrenNodes1,childrenNodes2,doom_core__$VNode_VNode_$Impl_$.el("button",_g1,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("reset counter",null,null)]))]);
		}
		var _g2 = new haxe_ds_StringMap();
		var value3 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("position:fixed; top:0px; left:0px; width:100%; height:100%;");
		if(__map_reserved["style"] != null) {
			_g2.setReserved("style",value3);
		} else {
			_g2.h["style"] = value3;
		}
		...
		if(__map_reserved["click"] != null) {
			_g2.setReserved("click",value4);
		} else {
			_g2.h["click"] = value4;
		}
		var mainNode = doom_core__$VNode_VNode_$Impl_$.el("div",_g2,childrenNodes);
		return mainNode;
	}
	,onClick: function() {
		this.update(thx_Objects.shallowCombine(this.props,{ clicks : this.props.clicks + 1}),{ fileName : "CounterExample.hx", lineNumber : 59, className : "ClickCounter", methodName : "onClick"});
	}
	,reset: function() {
		haxe_Log.trace("Setting counter back to 0!",{ fileName : "CounterExample.hx", lineNumber : 67, className : "ClickCounter", methodName : "reset"});
		this.update(thx_Objects.shallowCombine(this.props,{ clicks : 0}),{ fileName : "CounterExample.hx", lineNumber : 68, className : "ClickCounter", methodName : "reset"});
...
doom_html_Render.prototype = {
	...
	,applyElementToNode: function(name,attributes,children,dom,parent,post) {
		...
		if(dom.nodeType == 1 && dom.tagName == name.toUpperCase()) {
			...
			thx_Arrays.each(this.zipVNodesAndNodeList(children,dom.childNodes),function(t) {
				_gthis.applyToNode(t._0,t._1,dom,post,false);
			});
			return dom;
		} else {
	...
	,createElement: function(name,attributes,children,post) {
		...
		if(colonPos > 0) {
			...
			if(null == ns) {
				throw new thx_Error("element prefix \"" + prefix + "\" is not associated to any namespace. Add the right namespace to Doom.namespaces.",null,{ fileName : "Render.hx", lineNumber : 410, className : "doom.html.Render", methodName : "createElement"});
			}
