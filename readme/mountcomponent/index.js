...
BannerComponent.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		...
		thx_Timer.delay(function() {
			_gthis.update(thx_Objects.shallowCombine(_gthis.props,{ toDisplay : (_gthis.props.toDisplay + 1) % _gthis.props.messages.length}),{ fileName : "Main.hx", lineNumber : 20, className : "BannerComponent", methodName : "render"});
		},this.props.delay);
