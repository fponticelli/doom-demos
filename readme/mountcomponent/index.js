// Generated by Haxe 3.3.0 (git build development @ 9c737f9)
...
Main.__name__ = ["Main"];
Main.main = function() {
	var div = window.document.getElementById("main");
...
BannerComponent.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		...
		thx_Timer.delay(function() {
			_gthis.update(thx_Objects.combine(_gthis.props,{ toDisplay : (_gthis.props.toDisplay + 1) % _gthis.props.messages.length}));
		},this.props.delay);
		return doom_core__$VNode_VNode_$Impl_$.el("h1",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(this.props.messages[this.props.toDisplay])]));
	}
	,classes: function() {
