...
Main.__name__ = ["Main"];
Main.main = function() {
	Doom.browser.mount(doom_core__$VNode_VNode_$Impl_$.el("h1",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("I'm just a simple element",null,null)])),window.document.getElementById("main"));
};
Math.__name__ = ["Math"];
